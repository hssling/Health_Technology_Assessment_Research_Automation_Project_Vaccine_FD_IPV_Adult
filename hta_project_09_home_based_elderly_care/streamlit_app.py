...
# Page configuration
st.set_page_config(
    page_title="Home-Based Elderly Care",
    page_icon="🏠",
    layout="wide",
...
def main():
    ...
    # Main header
    st.markdown('<h1 class="main-header">🏠 Home-Based Elderly Care</h1>', unsafe_allow_html=True)
    st.markdown("**Cost-Effectiveness Analysis of Home-Based Care Programs for Elderly Population**")
