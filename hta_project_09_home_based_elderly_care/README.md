# 🏠 Home-Based Elderly Care Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-home-based-elderly-care.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of cost-effectiveness analysis of home-based care programs for elderly population.
...
Access the interactive dashboard at: [https://hta-home-based-elderly-care.streamlit.app/](https://hta-home-based-elderly-care.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-home-based-elderly-care-dashboard.git
   cd hta-home-based-elderly-care-dashboard
   ```
...
```bibtex
@software{siddalingaiah_home_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {Home-Based Elderly Care Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-home-based-elderly-care.streamlit.app/}
}
```
