...
# Page configuration
st.set_page_config(
    page_title="AMR POCT Stewardship",
    page_icon="🧬",
    layout="wide",
...
def main():
    ...
    # Main header
    st.markdown('<h1 class="main-header">🧬 AMR POCT Stewardship</h1>', unsafe_allow_html=True)
    st.markdown("**Cost-Effectiveness Analysis of Point-of-Care Testing for Antimicrobial Resistance Stewardship**")
