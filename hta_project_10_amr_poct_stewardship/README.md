# 🧬 AMR POCT Stewardship Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-amr-poct-stewardship.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of cost-effectiveness analysis of point-of-care testing for antimicrobial resistance stewardship.
...
Access the interactive dashboard at: [https://hta-amr-poct-stewardship.streamlit.app/](https://hta-amr-poct-stewardship.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-amr-poct-stewardship-dashboard.git
   cd hta-amr-poct-stewardship-dashboard
   ```
...
```bibtex
@software{siddalingaiah_amr_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {AMR POCT Stewardship Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-amr-poct-stewardship.streamlit.app/}
}
```
